...
<?php
	...
	printf(
		__( 'From your account dashboard you can edit your<br /><a href="%1$s"> profile details</a> and <a href="%2$s">edit your password</a>.', 'user-registration' ),
...
<p class="profile-logout">
	<?php
		...
		printf(
			__( 'Not %1$s?<br /><a href="%2$s">Sign out</a>', 'user-registration' ),
